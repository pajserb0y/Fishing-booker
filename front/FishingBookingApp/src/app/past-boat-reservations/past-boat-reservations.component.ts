...
@Component({
  selector: 'app-past-boat-reservations',
  templateUrl: './past-boat-reservations.component.html',
  styleUrls: ['./past-boat-reservations.component.css']
})
export class PastBoatReservationsComponent implements OnInit {
